...
if __name__ == "__main__":
    ...
    # kns = [15,15,15,10,10,10,5,5,5,5]
    # kns = [15,15,10,10,10,5,5,5,5]
    # kns = [10 for i in range(10)]
    kns = [20,20,10,10,10,10,5,5,5,5]
    for i in range(10):
        ...
        for j in range(10):
            ...
            # H = multiview_to_hypergraph_finch(Xs, metric=METRIC, neighbors=K_Neighbors)
            ...
            print("No.", j, DATASET, " C:", C, " ACC:", acc)
            ACCS.append(acc)
        with open("MSRC-v1.txt", "a+", encoding="UTF-8") as f:
